...
import { Download, Save, Sparkles, Loader2, Edit, Monitor, AlertTriangle } from 'lucide-react'
        ...
        <TabsContent value="edit">
          <form className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <Controller // used to wrap the third parties input field like textarea or input so that they work with react hook form
                name="summary"
                control={control}
                render={({ field }) => (
                  <Textarea
